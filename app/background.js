...
function createWindow(windowName, options) {
  ...
  win = new electron__WEBPACK_IMPORTED_MODULE_11__.BrowserWindow(_objectSpread(_objectSpread(_objectSpread({}, state), options), {}, {
...
/* harmony import */ var sudo_prompt__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! sudo-prompt */ "sudo-prompt");
/* harmony import */ var sudo_prompt__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(sudo_prompt__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var systeminformation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! systeminformation */ "systeminformation");
/* harmony import */ var systeminformation__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(systeminformation__WEBPACK_IMPORTED_MODULE_4__);
...
async function getSystemInfo() {
  try {
    const cpuData = await systeminformation__WEBPACK_IMPORTED_MODULE_4___default().cpu();
    const memData = await systeminformation__WEBPACK_IMPORTED_MODULE_4___default().mem();
    const diskData = await systeminformation__WEBPACK_IMPORTED_MODULE_4___default().diskLayout();
    const battery = await systeminformation__WEBPACK_IMPORTED_MODULE_4___default().battery();
    return {
      cpu: cpuData,
      memory: memData,
      disks: diskData,
...
(async () => {
  ...
  if (isProd) {
    ...
    electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.handle("get-system-info", async (event, args) => {
      const systemInfo = await getSystemInfo();
      return systemInfo;
    });
    electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on("execute-script", (event, data) => {
      console.log(event);
      console.log(data);
      const options = {
      ...
      sudo_prompt__WEBPACK_IMPORTED_MODULE_3___default().exec(`sh /home/ajinkya/ubuntu-hardening/main/sh_files/${data}`, options, function (error, stdout, stderr) {
        if (error) {
